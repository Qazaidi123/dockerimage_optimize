...
# Frontend Dockerfile with alpine: FROM nginx:alpine (Image name: qazaidi123/frontopt:4) - frontend 
...
# Backend Dockerfile with alpine: FROM php-cli-alpine  (Image name: qazaidi123/backopt:4) - backend
